...
new_blouse = Blouse("green", "large", "patterned", 35, "New Zealand")
print(new_blouse.price)
print(new_blouse.color)
print(new_blouse.triple_price())
new_pants = Pants("blue","small","slim",100,34)
print(new_pants.price)
print(new_pants.calculate_discount(.4))
